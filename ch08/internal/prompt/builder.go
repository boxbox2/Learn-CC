...
const (
	...
	SectionSkillCatalog SectionKind = "skills_catalog"
	SectionActiveSkills SectionKind = "active_skills"
...
func sectionPriority(kind SectionKind) int {
	...
	case SectionEnvironment:
		return 80
	case SectionActiveSkills:
		return 85
	case SectionCustom:
		return 90
	case SectionSkills, SectionSkillCatalog:
		return 100
	case SectionMemory:
		return 110
	default:
